...
app.use('/', httpProxy({
    ...
    autoRewrite:  true,
    router: function (req) {
        if (req.path.indexOf('/v3/stamen.i808gmk2/') >-1 ) {
          var myRegexp = /(stamen.i808gmk2\/)(\w+)\/(\w+)\/(\w+)/g
          var match = myRegexp.exec(req.path);

        return `${API_SERVER}/styles/v1/thadk/cj4fts6o83n4a2rnpnqi6uuk6/tiles/256/17/61618/63242@2x?access_token=pk.eyJ1IjoidGhhZGsiLCJhIjoidWlIX1J4OCJ9.BZnfrT_Jdc8aSQyWV8fL7g`
      }
    },
    pathRewrite: {'^v3/stamen.i808gmk2/17/61617/63244.png' : '/new/api'}
